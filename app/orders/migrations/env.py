...
# Ensure all orders models are registered on the metadata before autogenerate.
_ = (Order, OrderItem, OrderAdjustment, TimestampMixin)
...
config.set_main_option("sqlalchemy.url", f"{settings.database_base_url}/commerce_orders")
