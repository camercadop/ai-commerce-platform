...
from app.inventory.models import InventoryItem, MovementKind, Reservation, ReservationStatus, StockMovement
from app.shared.db import BaseModel, TimestampMixin

# Ensure all inventory models are registered on the metadata before autogenerate.
_ = (InventoryItem, StockMovement, Reservation, MovementKind, ReservationStatus, TimestampMixin)
...
config.set_main_option("sqlalchemy.url", f"{settings.database_base_url}/commerce_inventory")
