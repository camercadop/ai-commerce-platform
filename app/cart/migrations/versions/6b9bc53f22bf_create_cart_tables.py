...
def upgrade() -> None:
    ...
    op.create_table('commerce_cart_carts',
    ...
    op.create_index('idx_cart_carts_customer_id', 'commerce_cart_carts', ['customer_id'], unique=False)
    op.create_table('commerce_cart_items',
    sa.Column('id', sa.UUID(), nullable=False),
    ...
    sa.ForeignKeyConstraint(['cart_id'], ['commerce_cart_carts.id'], name='fk_cart_items_cart_id'),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('cart_id', 'variant_id', name='uq_cart_items_cart_id_variant_id')
    )
    op.create_index('idx_cart_items_cart_id', 'commerce_cart_items', ['cart_id'], unique=False)
...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index('idx_cart_items_cart_id', table_name='commerce_cart_items')
    op.drop_table('commerce_cart_items')
    op.drop_index('idx_cart_carts_customer_id', table_name='commerce_cart_carts')
    op.drop_table('commerce_cart_carts')
    # ### end Alembic commands ###
