...
# Ensure all cart models are registered on the metadata before autogenerate.
_ = (Cart, CartItem, TimestampMixin)
...
config.set_main_option("sqlalchemy.url", f"{settings.database_base_url}/commerce_cart")
